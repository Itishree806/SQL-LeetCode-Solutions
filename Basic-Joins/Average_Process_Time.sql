...
-- Approach:
-- Join start and end activities of the same process
-- Calculate time difference and take average per machine
...
WHERE 
    start.activity_type = 'start'AND end.activity_type = 'end'
GROUP BY 
    start.machine_id;
